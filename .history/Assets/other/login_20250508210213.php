    ...
    if($_POST['user']=='resp')
      {
        ...
        if($users-> rowCount()>0){
          ...
          header('location:../responsable/vue/pageresponsable.php?Matricule='.$_SESSION['Matricule_resp']);
        ...
        if($users-> rowCount()>0){
          ...
          header("location:../employe/vue/pageemp.php?Matricule=".$_SESSION["Matricule_emp"]);
