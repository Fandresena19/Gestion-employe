...
$matricule = $bdd->query('SELECT matricule FROM employer_login WHERE matricule_emp ='.$employe) ->fetch();
...
<div class="contenu">
  ...
  <form action="../traitement/add_conge.php" method="post">
    <div class="form-group">
      ...
      <input type="text" class="form-control" value="<?php echo $matricule ?>" readonly>
    </div>
