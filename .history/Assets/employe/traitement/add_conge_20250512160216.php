...
$matricule_emp = $_SESSION['matricule']; // ou récupéré depuis le formulaire
$matricule_resp = 'R001'; // à définir dynamiquement si nécessaire
...
$insertNotif = $bdd->prepare("INSERT INTO notifications_responsable (matricule_emp, matricule_resp, Genre_notif, Message_resp, TYPE, date_notif_resp, Statut_notif_resp) VALUES (?, ?, ?, ?, ?, ?, ?)");
