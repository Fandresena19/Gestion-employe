...
$insertNotif = $conn->prepare("INSERT INTO notifications_responsable (matricule_emp, matricule_resp, Genre_notif, Message_resp, TYPE, date_notif_resp, Statut_notif_resp) VALUES (?, ?, ?, ?, ?, ?, ?)");
