...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $notif = "INSERT INTO notifiations_responsable (matricule_emp, Fenre_notif, Message_resp, 
        type, date_notif_resp, statut_notif_resp)
        VALUES (:matricule_emp, 'Nouveau Timesheet' , : message, 'Timesheet', :date_notif_resp, :Statut_notif_resp)";
