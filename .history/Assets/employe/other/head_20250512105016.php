        ...
        <div class="menu">
          <ul class="list-unstyled nav-links">
            <a href="../vue/pageemp.php">
              <li><img src="../../Icone/user.png" alt="" width="25px" class="icone">
              <span class="Stexte">Profil</span></li>
            </a>

            <a href="../vue/mes_conge.php">
              <li><img src="../../Icone/leave.png" alt="" width="20px" class="icone">
              <span class="Stexte">Congé</span></li>
            </a>

            <a href="../vue/mes_permission.php">
              <li><img src="../../Icone/permission.png" alt="" width="20px" class="icone">
              <span class="Stexte">Permission</span></li>
            </a>

            <a href="../vue/mes_timesheet.php">
              <li><img src="../../Icone/timesheet.png" alt="" width="20px" class="icone">
              <span class="Stexte">Timesheet</span></li>
            </a>

            <a href="../vue/historique.php">
              <li><img src="../../Icone/historique.png" alt="" width="20px" class="icone">
              <span class="Stexte">Historique</span></li>
            </a>
            ...
            <a href="../vue/notif.php">
              <li>
                ...
                <span class="Stexte">Notifications</span>
              </li>
            </a>

            <a href="#">
              <li onclick="document.getElementById('id01').style.display='block'">
                <img src="../../Icone/logout.png" alt="" width="-25px" height="20px" class="icone">
                <span class="Stexte">Deconnexion</span>
              </li>
            </a><br>
