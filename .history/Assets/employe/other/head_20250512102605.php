...
$sql_notif = "SELECT COUNT(*) as unread_count FROM notifications WHERE matricule_emp = :id_user AND statut_notif = 'non lu'";
...
<body>
  ...
  <div class="container-fluid" id="container">
    ...
    <script>
      // Script to toggle sidebar and save state to localStorage
