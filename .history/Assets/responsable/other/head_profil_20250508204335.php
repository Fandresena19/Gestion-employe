...
<body>
  ...
  <div class="container-fluid">
    <form action="edit_resp.php" method="post" enctype="multipart/form-data">
<div id="container">
      <nav class="sidebar" id="side_nav">
        <header>
          <div class="image-text">
            <span class="image">
              <img src="../Icone/Logo2.png" alt="">
            </span>
      ...
      <div class="dashboard" id="Main"></div>