...
$employe =  $bdd->query("SELECT matricule FROM employer_login ORDER BY matricule DESC LIMIT 1");
$last_M = ($employe->rowCount()>0)? intval($employe->fetch()['matricule']) +1 : 1;
...
<form action="../traitement/add_employe.php" method="post">
  ...
  <div class="contenu">
    ...
    <div class="form-group">
      ...
      <input type="text" name="im" class="form-control" value="<?=$last_M ?>" readonly required>
    </div>
