...
// Vérifier si une ID existe
$last_id = ($result->rowCount() > 0) ? $result->fetch()['matricule_emp'] : 1; // Si aucun enregistrement, afficher 1

?>

<form action="../traitement/add_employe.php">
  ...
  <div class="contenu">
    ...
    <div class="form-group">
      ...
      <input type="text" name="im" class="form-control" placeholder="<?= $last_id ?>" required>
    </div>
